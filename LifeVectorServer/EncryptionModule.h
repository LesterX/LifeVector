...
//! New types are defined here including unsigned chars as bytes, secure_strings and an EVP CIPHER for AES/RSA
//
 ...
 *  *        Description: Contains methods for base64 encoding/decoding, RSA encryption/decryption, AES_256_CTR Cipher encryption/decryption methods
 *   *     
 *    *      Details:
 *    		A secure_string struct is defined in order to use the AES encryption and decryption methods
 *              The AES Key and Block size constants are also defined at the top
